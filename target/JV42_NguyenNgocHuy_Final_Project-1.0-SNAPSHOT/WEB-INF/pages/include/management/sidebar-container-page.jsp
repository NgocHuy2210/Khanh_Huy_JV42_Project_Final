...
<!--    <a href="<c:url value="/admin/index"/>" class="brand-link">
    ...
    <sec:authorize access="isAuthenticated()">
        ...
        <sec:authorize access="hasRole('ROLE_MANAGER')">
            <a href="<c:url value="/manager/index"/>" class="brand-link">
                <img src="<c:url value="/resources-management/dist/img/AdminLTELogo.png" />" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">AdminLTE 3</span>
            </a>
        </sec:authorize>
        <sec:authorize access="hasRole('ROLE_RECEPTIONIST')">
            <a href="<c:url value="/receptionist/index"/>" class="brand-link">
                <img src="<c:url value="/resources-management/dist/img/AdminLTELogo.png" />" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">AdminLTE 3</span>
            </a>
        </sec:authorize>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <sec:authorize access="isAuthenticated()">
                    <sec:authorize access="hasRole('ROLE_ADMIN')">
                        <li class="nav-item">
                            <a href="<c:url value="/admin/index"/>" class="nav-link">
                    ...
                    <sec:authorize access="hasRole('ROLE_MANAGER')">
                        <li class="nav-item">
                            <a href="<c:url value="/manager/index"/>" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                    ...
                    <sec:authorize access="hasRole('ROLE_RECEPTIONIST')">
                        <li class="nav-item">
                            <a href="<c:url value="/receptionist/index"/>" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/receptionist/booking-now" class="nav-link">
                                <i class="nav-icon fas fa-chart-pie"></i>
                                <p>
                                    Booking
                                    <i class="right fas fa-angle-left"></i>
